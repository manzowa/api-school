...
class AdresseMapper extends Mapper 
{
    public function retrieve(?int $id= null, ?int $ecoleid = null, ?Adresse $adresse = null):self
    {
        if (!is_null($id) && !is_null($ecoleid)) {
            ...
            ->bindParam(':ecoleid', $ecoleid, PDO::PARAM_INT);
             ...
             is_null($id) && is_null($ecoleid) 
            (!is_null($adresse) && $adresse instanceof Adresse)
        ) {
    ...
    public function add(Adresse $adresse): self
    {
        $voie = $adresse->getVoie();
        $quartier = $adresse->getQuartier();
    ...
    public function update(Adresse $adresse): self
    {
        $voie = $adresse->getVoie();
        $quartier = $adresse->getQuartier();
        $reference = $adresse->getReference();
